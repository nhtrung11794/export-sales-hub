...
- Giới hạn: Không sử dụng các thủ thuật vi phạm nghiêm trọng chính sách bảo mật dữ liệu cá nhân (GDPR/CCPA); tập trung vào dữ liệu công khai trên mạng chuyên nghiệp.`;
  ...
  const stepsData = [
    {
      step: 1,
      title: 'Bước 1: Chọn Plugin trên Menu Trái',
      badge: 'Đăng nhập & Mở Store',
      description: 'Đăng nhập vào ChatGPT trên trình duyệt. Tại thanh menu bên trái, tìm và nhấp chọn mục "@ Plugin" để mở kho tiện ích mở rộng.',
      imgSrc: '/images/tutorials/linkedin-plugin/step1-chatgpt-menu-plugin.png',
      alt: 'Bước 1: Chọn Plugin từ menu ChatGPT',
      overlays: [
        {
          id: 'b1-item',
          top: '34%',
          ...
          pulse: true,
          note: 'Mục Plugin nằm ở thanh điều hướng bên trái'
        }
      ]
    },
    {
      step: 2,
      title: 'Bước 2: Tìm kiếm & Kích hoạt Plugin LinkedIn',
      badge: 'Cài đặt Plugin',
      description: 'Trong kho Plugin công khai, gõ từ khóa "linkedin" vào ô tìm kiếm ở góc trên bên phải. Tìm plugin "LinkedIn - Find the right professional" và nhấp vào dấu cộng (+) để kích hoạt.',
      ...
      overlays: [
        {
          ...
          arrowDirection: 'down',
          pulse: false,
          note: 'Gõ "linkedin" vào ô tìm kiếm'
        },
        {
          id: 'b2-plus',
          top: '70.5%',
          ...
          arrowDirection: 'left',
          pulse: true,
          note: 'Nhấp dấu (+) để kích hoạt plugin LinkedIn'
        }
      ]
    },
    {
      step: 3,
      title: 'Bước 3: Kích hoạt Huy hiệu [in LinkedIn] trong Chat',
      badge: 'Gọi Tiện Ích',
      description: 'Quay lại màn hình trò chuyện mới. Kích hoạt plugin LinkedIn để xuất hiện huy hiệu màu xanh [in LinkedIn] ngay trước con trỏ văn bản trong khung nhập câu lệnh.',
      ...
      overlays: [
        {
          ...
          arrowDirection: 'up',
          pulse: true,
          note: 'Đảm bảo có huy hiệu xanh [in LinkedIn] trước khi dán prompt'
        }
      ]
    },
    {
      step: 4,
      title: 'Bước 4: Dán Prompt RCTO & Bắt đầu Sourcing',
      badge: 'Thực thi Lệnh',
      description: 'Sao chép đoạn prompt mẫu đã tùy biến theo ngành hàng bên dưới, dán vào khung chat của ChatGPT (đã có tag [in LinkedIn]) và bấm Gửi để AI bắt đầu cào và tổng hợp danh sách khách hàng tiềm năng.',
      ...
      overlays: [
        {
          ...
          arrowDirection: 'down',
          pulse: false,
          note: 'Dán đoạn prompt đầy đủ thông tin thị trường và ngành hàng'
        },
        {
          id: 'b4-send',
          top: '71.5%',
          ...
          arrowDirection: 'left',
          pulse: true,
          note: 'Bấm nút gửi để AI thực thi quét dữ liệu'
        }
      ]
    }
  ];
  ...
  return (
    <div style={{
      ...
      <div style={{
            ...
            return (
              <button
                ...
                style={{
                  ...
                  background: isActive ? 'linear-gradient(135deg, rgba(14, 165, 233, 0.15) 0%, rgba(30, 41, 59, 0.6) 100%)' : 'rgba(30, 41, 59, 0.4)',
        ...
        {/* ACTIVE STEP DETAILS & IMAGE WITH NEON OVERLAYS */}
        {(() => {
          const s = stepsData[activeStep - 1];
          return (
            <div style={{
              ...
              <div style={{
                ...
                <div>
                  ...
                  <p style={{ margin: '4px 0 0 0', fontSize: '0.85rem', color: '#cbd5e1', lineHeight: '1.45' }}>
                    {s.description}
                  </p>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: activeStep === 4 ? '#475569' : '#38bdf8',
              ...
              {/* IMAGE CONTAINER WITH NEON OVERLAYS */}
              <div style={{
                position: 'relative',
                background: '#020617',
                display: 'flex',
                ...
                <div style={{
                    ...
                    <React.Fragment key={ov.id}>
                      ...
                      <div
                        style={{
                          ...
                          borderRadius: '6px',
                          boxShadow: '0 0 15px rgba(0, 242, 254, 0.8), inset 0 0 10px rgba(0, 242, 254, 0.3)',
                          pointerEvents: 'none'
                        }}
                      />
                      ...
                      <div
                        style={{
                          ...
                          boxShadow: '0 4px 12px rgba(0,0,0,0.5), 0 0 10px rgba(14, 165, 233, 0.5)',
                  ...
                  <button
                    onClick={() => setZoomedImg({ src: s.imgSrc, alt: s.alt, step: s.step })}
                    style={{
                      position: 'absolute',
                      bottom: '12px',
                      right: '12px',
        ...
        <div style={{
          ...
          {/* CỘT PHẢI: KHUNG LÝ THUYẾT RCTO & LƯU Ý B2B */}
          <div style={{
            display: 'flex',
            flexDirection: 'column',
            gap: '16px'
            ...
            <div style={{
              ...
              <p style={{ margin: 0, fontSize: '0.78rem', color: '#cbd5e1', lineHeight: '1.45' }}>
                ...
                <strong style={{ color: '#38bdf8' }}> "📥 Nhập nhanh danh sách"</strong> tại Buổi 06. Hệ thống sẽ tự động tách Tên công ty, Website, Quy mô và chấm điểm ICP Match ngay lập tức!
              </p>
            </div>
          </div>
        </div>
